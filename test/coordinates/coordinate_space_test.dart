...
void main() {
  ...
  group('interaction with computePreviewContentRect', () {
    test('a point tapped on the rendered content maps back to itself', () {
      ...
      // sharing computePreviewContentRect is what keeps them aligned.
    ...
    test('contain letterboxes, cover overflows -- both round-trip', () {
      ...
      final contain = computePreviewContentRect(
        widgetSize: widgetSize,
        contentSize: contentSize,
        fit: PreviewFit.contain,
      );
      final cover = computePreviewContentRect(
        widgetSize: widgetSize,
        contentSize: contentSize,
