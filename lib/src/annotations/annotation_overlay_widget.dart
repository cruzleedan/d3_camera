...
import '../preview/preview_transform.dart';
...
/// with the same `computePreviewContentRect` the preview uses, so a mark
...
class _AnnotationOverlayState extends State<AnnotationOverlay> {
  ...
  Rect _contentRect(Size widgetSize) => computePreviewContentRect(
        ...
        return AnimatedBuilder(
          ...
          builder: (context, _) {
            ...
            return GestureDetector(
              ...
              onPanStart: (d) => _onPanStart(d.localPosition, contentRect),
              onPanUpdate: (d) => _onPanUpdate(d.localPosition, contentRect),
